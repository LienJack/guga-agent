...
| [Agent Reference Projects Guide](./agent-reference-projects-guide.md) | Interpret "参考全项目" as a research-scope phrase and use the agent reference corpus | When research, planning, roadmap, or architecture work references full-project examples |
...
### When to Use Agent Reference Projects for Research
