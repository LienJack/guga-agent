# M33 Memory JSONL Review Markdown Capability Plan

Date: 2026-05-28

## Scope

Expose the durable JSONL review Markdown projection as a plugin-owned read-only operation descriptor.

## Units

- U1: Trellis task context, research, and plan artifacts.
- U2: Add `memory.jsonl.review_markdown` descriptor registration.
