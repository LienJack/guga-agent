...
> Converted from the survey PDF into Markdown for local reading. This is an automated text extraction, so tables, figures, formulas, and multi-column ordering may need manual cleanup before citation.

- Source PDF: https://picrew.github.io/LLM-Harness/main.pdf
- OpenReview: https://openreview.net/forum?id=3hXEPbG0dh
- Project page: https://picrew.github.io/LLM-Harness/
- Local PDF: `docs/research/papers/agent-harness-engineering-a-survey.pdf`
- Page count: 71
...
1CMU, 2Yale, 3JHU, 4NEU, 5Tulane, 6UAB, 7OSU, 8Virginia Tech, 9Amazon
...
Lifecycle &
Multi-Agent Orchestration Patterns                                  Harness                Orchestration (L) (§6)

Full Lifecycle Task Pipelines                                                                  Engineering                        Agent                                                            Tracing and Monitoring Platforms
...
Computer-Use                  Anthropic Computer Use (Anthropic, 2024b), CUA (Cua, 2024),
Agent Infrastructure            OSWorld (Xie et al., 2024)

Code and Repository              Judge0 (Došilović, 2024), OpenAI Code Interpreter (OpenAI, 2023),
Execution Sandboxes              sandboxed.sh (Th0rgal, 2026), langchain-sandbox (LangChain, 2025c), Repo2Run (Hu et al., 2025a)

Framework-Integrated            OpenHands (Wang et al., 2025b), GoEX (Patil et al., 2024a),
Runtimes                       agent-infra sandbox (Agent Infra, 2024), smolagents executors (Roucher et al., 2025)

Browser                               Evaluation             WebArena                                                                 (Zhou                                                                                        et al., 2024),                                                                                  VisualWebArena                                                                                            (Koh                                                                                                                              et al.,                                                                                                                             2024),
Environments                                                   BrowserGym                                                                               (Chezelles                                                                                               et al., 2024),                                                                                  WorkArena                                                                                                        (Drouin                                                                                                                                  et                                                                                                                                                                     al., 2024)    Execution          Sandbox&                  Environment
...
(Model                                                                            Context                                                                                              Protocol,                                                                                                         2025b;c),                                                                            A2A                                                                                         (A2A                                                                                                                               Project,                                                                                                                                     2025),
Protocol                                 and             MCPFunction                                                                                 Calling                                                                            (OpenAI,                                                                                                  2026c),                                                                                OpenAPI                                                                                            (OpenAPI                                                                                                                                                  Initiative,                                                                                                                                         2025),
Interface                                 Standards
AGENTS.md                                                                               (agentsmd,                                                                                                 2025),                                                                                                           Interop.                                                                                                     Survey                                                                                                      (Ehtesham                                                                                                                                           et                                                                                                                                                                                al.,                                                                                                                                2025)

(Yuan                                                                                             et                                                                                                                       al.,                                                                                              2025),                                                                               MCP-Zero                                                                                                                      (Fei                                                                                                                            et                                                                                                                                                             al.,                                                                                                                           2025),
Tool Description,                                         Discovery,            EasyToolCRAFT                                                                   (Yuan                                                                                            et                                                                                                                      al.,                                                                                             2023),                                                                                     MetaTool                                                                                           (Huang                                                                                                                              et                                                                                                                                                               al.,                                                                                                                            2023),
and Selection
ToolRegistry                                                                                  (Ding,                                                                                            2025),                                                                                       ToolRet                                                                                                           (Shi                                                                                                                       et                                                                                                                                                       al.,                                                                                                           2025b)                 Interface                                                           Toolformer (Schick et al., 2023), Gorilla (Patil et al., 2024b),AnyToolToolLLM/ToolBench(Du et al., 2024),(Qin et al., 2024),                         Protocol             Tool-Augmented Training            ToolkenGPT (Hao et al., 2023), CREATOR (Qian et al., 2023b),
Tool &                 and Integration                   AgenticSemanticCodeKernelReasoning(Microsoft,(Ugare2026),& Chandra,smolagents2026),(HuggingLangChainFace, 2026)(LangChain, 2026c),

(Yao                                                                                         et al.,                                                                                          2023),                                                                             LLMCompiler                                                                                       (Kim                                                                                                                            et                                                                                                                                                              al.,                                                                                                                           2024),                                                                                             E2B                                                                                                                      (E2B,                                                                                                                                              2024),
Scalability                                  and                 ReActMCP                                                             Code                                                                            Execution                                                                                           (Anthropic,                                                                                                              2025f),                                                                            BFCL                                                                                                                                (Patil                                                                                                                                      et                                                                                                                                                                          al.,                                                                                                                                     2025),
Session                           Management
...
of scope. References appear in the surrounding text.             G#=                #

Boundary          Standard                Wire    Typed  Runtime disc.  Long-running
Model ↔Function     Function calling            JSON             #          #
MCP                  JSON-RPC
Agent ↔Capability                  OpenAPI               HTTP                                               G#
G#          #
A2A                  JSON-RPC
Agent ↔Agent
ACP / ANP             HTTP
Agent ↔Repo / env  AGENTS.md / AGENT.md   Markdown    #              G#          #
...
Short-Term Active               Manus Context Engineering (Manus Team, 2025),
Context Window                  Context Management (Anthropic, 2025c), Agent Skills (Koylan, 2025),
Context-Space (context-space, 2025)

Structured Note-Taking (Anthropic Applied AI Team, 2025),
Mid-Term Session State                Planning-with-Files (OthmanAdi, 2025), Trellis (mindfold-ai, 2025),
and Cross-Run Persistence            Claude-Mem (thedotmack, 2025),
Everything-Claude-Code (affaan-m, 2025)

MemGPT (Packer et al., 2023), Generative Agents (Park et al., 2023),           Memory                Long-Term Persistent             MemoryBank (Zhong et al., 2024),
&                Memory Systems             Mem0 (Chhikara et al., 2025), A-MEM (Xu et al., 2025), Hindsight (Vectorize.io, 2025),
Honcho (Plastic Labs, 2025), CQ (Mozilla AI, 2025)                               Management                                                      Context Compaction (Anthropic Applied AI Team, 2025),
Sub-Agent                                                                         Context                                                                                                 Isolation                                                                                                 (Anthropic,                                                                                                                2025e),
Long-Horizon
Manus                                                                      Context                                                                                 Sharing                                                                              (Manus                                                                                      Team, 2025),             Context                  Context                                 Techniques
...
Context Drift                    Harness Boundary (Bowne-Anderson & Huber, 2026),
and Limits                 MemBench (Tan et al., 2025), MemoryArena (He et al., 2026),
...
between every token in the context (Vaswani et al., 2017). For n tokens, this produces n2 pairwise weights;
...
Learning from experience.  Hindsight (Vectorize.io, 2025) takes the position that most memory sys-
...
The nature of the problem.  Context drift is distinct from context rot, though both arise from the
...
Emdash (Action, 2026)                 Lifecycle                                         Orchestration
Task Runners (OpenAI, 2026a; LangChain, 2026b),
Full Lifecycle Pipeline                  Effective Harnesses (Anthropic, 2025d),
from Issue to Pull Request             Vibe Kanban (Bloop-AI, 2026), Symphony (OpenAI, 2026b),
...
(Langfuse,                                                                                            2026),                                                                                  Opik                                                                                     (Comet                                                                                   ML,                                                                                                                     2026), Phoenix                                                                                                                                   (Arize                                                                                                                                      AI, 2026b),                                                                                                                           MLflow (MLflow,                                                                                                                                                                         2026),
Tracing                                 and                     LangfuseOpenTelemetry                                                                               (OpenTelemetry,                                                                                                         2026), OpenLLMetry                                                                                                                             (Traceloop,                                                                                                                                          2026),                                                                                                                                     OpenInference                                                                                                                                                              (Arize AI,                                                                                                                                                                       2026a),
...
(TensorZero,                                                                                                2026),                                                                                                   Helicone                                                                                                                  (Helicone,                                                                                                                          2026),                                                                                                        FrugalGPT (Chen et al., 2023),
Cost                                 Tracking                    TensorZeroGPTCache                                                                            (Bang,                                                                                          2023),                                                                         QC-Opt                                                                                                (Shekhar                                                                                                                          et                                                                                                                                                           al.,                                                                                                                          2024),
and                              Optimization
TALE (Han                                                                                         et al., 2025),                                                                                        Dual-Pool                                                                                               Routing                                                                                                                (Liu                                                                                                                                 et                                                                                                                                                                   al., 2026b)                               Operations                                                                Effective Harnesses (Anthropic, 2025d), Harness Design (Anthropic, 2026c),
Reliability                   Managed Agents (Anthropic, 2026b), MAST (Cemri et al., 2025),                         Observability                       Engineering                   AgentErrorTaxonomy (Zhu et al., 2025), SentinelAgent (He et al., 2025),
AgentFixer (Mulian et al., 2026), QSAF (Atta et al., 2025)

Taming Uncertainty (Moshkovich & Zeltyn, 2025),
Unified                     Beyond Black-Box Benchmarking (Moshkovich et al., 2025), Mind the Metrics (Koc et al., 2025),
Observability              NLAH (Pan et al., 2026), Deep-Agent Evaluation (LangChain, 2025a),
...
Unified LLMOps stacks.  Tools like TensorZero and Langfuse are moving toward bundling gateway,
...
Task and Benchmark                VisualWebArena (Koh et al., 2024), BrowserGym (Chezelles et al., 2024), WorkArena (Drouin et al., 2024),
Grounding                    OSWorld (Xie et al., 2024), AgentBench (Liu et al., 2023a), GAIA (Mialon et al., 2023),
...
Verification  Evaluation                 Multi-Level Judgement               ReActMT-Bench(Yaoandet al.,Chatbot2023),ArenaG-Eval(Zheng(Liu etetal.,al.,2023b),2023), LLM-as-Judge Survey (Gu et al., 2024),
and Failure Attribution              SWE-bench (Jimenez et al., 2024), OSWorld (Xie et al., 2024),
...
Figure 12: The task-to-feedback lifecycle for harness evaluation. Section V organizes verification and evalu-
...
This lifecycle reframes evaluation from a leaderboard mechanism into a quality-control loop for agent harnesses. A final success rate remains useful, but it is no longer sufficient. For long-running agents, the central
...
(Shi                                                                                         et                                                                                                                   al.,                                                                                         2025a),                                                                                           Contextual                                                                                              Agent                                                                                                                     Security                                                                                                                               (Tsai                                                                            &                                                                                                                              Bagdasarian,                                                                                                                                                   2025),
Permission                                 Models                 ProgentAuthenticated                                                                                  Delegation                                                                                        (South                                                                                                               et al.,                                                                                                               2025),                                                                           SAGA                                                                                                                        (Syros                                                                                                                                            et                                                                                                                                                                                 al.,                                                                                                                                          2025),
...
Lifecycle Hooks                   ShieldAgentCaMeL (Debenedetti(Chen et etal.,al.,2025b),2025),ControlValveAgentSpec (Wang(Jha etet al.,al., 2025),2026),
AgentDoG (Liu et al., 2026a)

Instruction Hierarchy (Wallace et al., 2024),
SecAlign                                                                   (Chen                                                                                             et                                                                                                                      al.,                                                                                            2025a),                                                                                   Llama                                                                                       Guard                                                                                                             (Inan                                                                                                                                 et al.,                                                                                                                                2023),  &                    Component
MCP                                                                            Safety                                                                           Audit                                                                                   (Radosevich                                                           &                                                                                                         Halloran,                                                                                                                   2025),
Hardening
Jumping                                                                             the                                                                               Line                                                                                                (Trail                                                                                                         of Bits,                                                                                                       2025),                                                                              ETDI                                                                                                          (Bhatt                                                                                                                                    et al.,                                                                                                                                  2025),
SAFEFLOW (Li et al., 2025)

Claude’s                                                                              Constitution                                                                                          (Anthropic,                                                                                                        2026a), AutoHarness (AIMing Lab, 2026),                         Security                      Declarative                                                                 Progent Policies                                                                                        (Shi et                                                                                                                             al., 2025a),                   Governance                       Constitutions                 Formal-LLM (Li et al., 2024), VeriSafeAgent (Lee et al., 2025),
AgentSpec (Wang et al., 2026)

AutoHarness (AIMing Lab, 2026), SAGA (Syros et al., 2025),
Audit                       AgentMonitor (Naihin et al., 2023), AgentAuditor (Luo et al., 2025),
Infrastructure                    SentinelAgent (He et al., 2025), OWASP LLM Top 10 (OWASP Foundation, 2025),
Agentic Governance Practices (Shavit et al., 2023)

and                                                                             Defense                                                                               Landscape                                                                                (Kim                                                                                                                   et                                                                                                                                                  al., 2026), Clawed                                                                                                           and Dangerous                                                                                                                         (Chen                                                                                                                                                                 et                                                                                                                                                                                                           al., 2026),
Agent                                    Security                   AttackAgentDojo                                                                             (Debenedetti                                                                                                      et                                                                                                                                  al.,                                                                                                      2024),                                                                                                             Jailbreaking                                                                                     LLMs                                                                                                                    (Andriushchenko                                                                                                                                                           et al.,                                                                                                                                                        2024),
Landscape
...
Context-dependent privilege control.  Progent (Shi et al., 2025a) introduces a domain-specific language
...
Input GR               Action GR                Post-exec IFC
...
Pre-execution hooks: input guardrails.  Input guardrails validate data before it reaches the LLM.
...
Pre-invocation hooks: output guardrails and action validation.  Before executing a tool call, output
...
Post-execution hooks: information flow control and taint tracking.  CaMeL (Debenedetti et al.,
...
Human-in-the-loop hooks.  Several widely used coding agents, including Codex, Gemini CLI, Cursor,
...
Open challenges.  Across current systems, hook APIs remain heterogeneous. We are not aware of a widely
...
Model hardening. A root cause of prompt injection is that LLMs treat all input text with equal priority,
...
Classifier-based runtime hardening. A complementary line of work hardens the model boundary with-
...
Supply chain risks.  Agent governance must also address the tools and packages that agents invoke.
...
Deployment-time constitutions: YAML-based governance.  The AutoHarness repository (AIMing
...
Programmable policy languages.  Progent’s policy language (Shi et al., 2025a) supports boolean pred-
...
Open challenges.  No widely adopted standard schema exists for agent constitutions. Each harness tends
...
Anomaly detection: per-action versus trajectory level.  Detection mechanisms split along the gran-
...
Open challenges.  Audit logs accumulate rapidly in long-running agents, raising challenges around storage,
...
Defense-in-depth and its limits.  Kim et al. argue that agent security requires layered defenses that
...
Table 4: Governance feature coverage.  = full support, G# = partial, # = absent.         System     Perm.  Hooks  Harden.  Constit.  Audit  Multi-Ag.

Codex
Gemini CLI                  G#     #      #          G#      #         OpenHands                  G#     #      #          G#      #           AutoHarness      G#           #      #          G#           G#           Progent                                   G#                                     G#        CaMeL                  #           G#     #      #        SAGA             G#           #      #     #      #           IsolateGPT                   G#     #      #          AgentSpec                    G#     #      #     #        SAFEFLOW      G#           #            #      #                                  G#                     G#      #
...
tool schema, verifier, or recovery loop changes the controller CH and therefore the measured behavior of the
...
and ownership. A mapping of 148+ open-source projects onto the taxonomy gives the most extensive
...
Aden.  Openhive:  Multi-agent swarms deployed in minutes for long-session business process.  https://
...
agentmd. AGENT.md: The universal agent configuration  file.  GitHub repository, 2025. URL https:
...
Anthropic.  Harness design for long-running application development.  https://www.anthropic.com/
...
Hugo Bowne-Anderson and Jeff Huber.  Harness engineering: Why agent context isn’t enough.  https:
...
Ji-Rong Wen, and Furu Wei.   Llm-in-sandbox  elicits general agentic  intelligence.   arXiv preprint
...
models.  In Findings of the Association for Computational Linguistics: ACL 2024, pp. 11143-11156,
...
aware in-IDE AI application development using the model context protocol (MCP).  arXiv preprint
...
Laminar AI.  Laminar (lmnr): Open-source observability platform purpose-built for AI agents.  https:
...
LangChain.     Evaluating  deep  agents:   Our  learnings.     https://www.langchain.com/blog/
...
your  terminal.   Google Blog, June 2025.  URL https://blog.google/technology/developers/
...
OpenAI.  Harness engineering:  leveraging Codex in an agent-first world.  https://openai.com/index/
...
OthmanAdi.    planning-with-files:   Persistent  file-based  planning.   https://github.com/OthmanAdi/
...
126544-126565,  2024b.  URL https://proceedings.neurips.cc/paper_files/paper/2024/hash/
...
promptfoo contributors.  Promptfoo: LLM evals and red teaming.  https://github.com/promptfoo/
...
els  can  teach  themselves  to  use  tools.    Advances  in  Neural  Information  Processing  Systems,
...
automation.    Advances  in  Neural  Information  Processing  Systems,  37:4540-4574,  2024.     doi:
...
them.     Trail  of  Bits  Blog,  April  2025.   URL  https://blog.trailofbits.com/2025/04/21/
...
Claude Code Plugins: Orchestration and      L       claude-code, plugins, orchestration                         34.9k
Automation
...
(Anthropic, 2025;a;b)       edit, debug, and Git loop.              workflows: codebase-aware prompting, shell/tool execution,
Layers: E, T, C, L, G                  repository edits, and explicit permission or sandbox bound-
...
(Anomaly, 2025)          with plan/build roles, subagents, LSP  terminal-agent loop, especially where role separation, sub-
support, and client-server runtime.     agent delegation, and editor/tool integration are exposed in
Layers: E, T, L                       the repository.
Codex CLI              Terminal-native coding agent;  state-  OpenAI’s Codex writeups make the harness loop explicit:
(OpenAI, 2025; 2026b;a)   less replay-oriented single-agent loop.   structured prompts, tool-call replay, local command execu-
Layers: E, T, L, V                       tion, and test or verification feedback jointly determine the
agent behavior.
OpenHands          Open software-engineering agent plat- A   research-grade   reference   for   repo-level   software
(Wang et al., 2025b;c)    form and composable agent SDK.      agents:    the  platform  couples  sandboxed  execution,
Layers: E, T, C, L, V                  shell/browser/tool interaction, task state, and benchmark-
oriented evaluation in one open system.
SWE-agent               Issue-fixing  coding  agent  centered  The key contribution is the agent-computer interface: com-
(Yang et al., 2024; SWE-  on an agent-computer interface and  mands, observations, editing actions, tests, and remote exe-
agent, 2025; SWE-agent SWE-ReX execution backends.         cution backends become part of the measured harness rather
Team, 2024)              Layers: E, T, L, V                   than incidental infrastructure.
Symphony            Codex orchestration spec and task-  Symphony treats the issue tracker and task runner as a
(OpenAI,         2026b;  runner workflow for issue-to-execution  durable control plane, making assignment, progress state,
Kotliarskyi et al., 2026)    control.                                 validation gates, and review boundaries explicit parts of
Layers: C, L, V, G                Codex orchestration.
