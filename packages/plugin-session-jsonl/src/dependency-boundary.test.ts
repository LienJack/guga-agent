...
describe("jsonl session plugin dependency boundary", () => {
  it("keeps JSONL persistence implementation outside core and avoids project metadata dependencies", async () => {
    ...
    expect(corePackage.dependencies ?? {}).not.toHaveProperty("@guga-agent/plugin-session-jsonl");
